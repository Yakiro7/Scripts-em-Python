...
def cadastrarr():
    ...
    labelLaboratorio = ctk.CTkLabel(janela, text="Laboratório: ").grid(row=1, column=1,padx=10, pady=10)
    caixaLaboratorio = ctk.CTkEntry(janela, placeholder_text="Digite o nome do Laboratório")
    caixaLaboratorio.grid(row=1, column=2,padx=10, pady=10, ipadx=20)

    labelEquipamentos = ctk.CTkLabel(janela, text="Equipamentos: ").grid(row=2, column=1,padx=10, pady=10)
    caixaEquipamentos = ctk.CTkEntry(janela, placeholder_text="Digite o ")
    caixaEquipamentos.grid(row=2, column=2,padx=10, pady=10, ipadx=20)
    ...
    caixaEspecificacao.grid(row=3, column=2,padx=10, pady=10, ipadx=20)
    ...
    caixaQuantidade.grid(row=4, column=2,padx=10, pady=10, ipadx=20)
